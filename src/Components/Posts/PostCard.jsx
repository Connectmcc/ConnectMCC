...
const PostCard = () => {
  ...
  return (
    <div className="py-4" >
      <div className="border rounded-md w-full">
        ...
        <div className="flex justify-between items-center w-full px-5 py-4">
          <div className="flex items-center space-x-2">
            ...
            <FaRegComment onClick={handleOpenCommentModule} className="text-xl hover:opacity-50 cursor-pointer" />
      ...
      <CommentModule handlePostLike={handlePostLike} onClose={onClose} isOpen={isOpen} handleSavePost={handleSavePost} isPostLiked={isPostLiked} isSaved={isSaved} />
    </div>
  );
};
